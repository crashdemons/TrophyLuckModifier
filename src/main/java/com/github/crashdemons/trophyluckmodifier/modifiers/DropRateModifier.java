...
public class DropRateModifier {
    ...
    public final static DropRateModifier None = new DropRateModifier(DropRateModifierType.NO_EFFECT,1.0);
    
    public com.github.crashdemons.miningtrophies.modifiers.DropRateModifier toMT(){
        return new com.github.crashdemons.miningtrophies.modifiers.DropRateModifier(type.toMT(),value,level);
    }
    public org.shininet.bukkit.playerheads.events.modifiers.DropRateModifier toPH(){
        return new org.shininet.bukkit.playerheads.events.modifiers.DropRateModifier(type.toPH(),value,level);
    }
